...
<script>
  ...
  <meta name="description" content="Config Arrayby Nicholas C. Zakas If you find this useful, please consider supporting my work with a donation. DescriptionA config array is a way of managing configurations that are based on glob patte">
<meta property="og:type" content="article">
<meta property="og:title" content="JackieLi的小屋">
<meta property="og:url" content="http://jackie-li-0228.github.io/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/index.html">
<meta property="og:site_name" content="JackieLi的小屋">
<meta property="og:description" content="Config Arrayby Nicholas C. Zakas If you find this useful, please consider supporting my work with a donation. DescriptionA config array is a way of managing configurations that are based on glob patte">
<meta property="og:locale" content="zh_CN">
<meta property="article:published_time" content="2024-10-29T14:18:58.765Z">
<meta property="article:modified_time" content="2024-09-03T03:23:42.677Z">
<meta property="article:author" content="JackieLi">
<meta property="article:tag" content="Programming Math Others">
<meta name="twitter:card" content="summary">

<link rel="canonical" href="http://jackie-li-0228.github.io/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/">
...
<div id="search-result">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-block" lang="zh-CN">
    <link itemprop="mainEntityOfPage" href="http://jackie-li-0228.github.io/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/">
    ...
    <span hidden itemprop="publisher" itemscope itemtype="http://schema.org/Organization">
      ...
      <header class="post-header">
        ...
        <div class="post-meta">
            ...
            <span id="/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/" class="post-meta-item leancloud_visitors" data-flag-title="" title="阅读次数">
              <span class="post-meta-item-icon">
                <i class="fa fa-eye"></i>
              </span>
  ...
  <span class="post-meta-item">
    ...
    <a title="valine" href="/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/#valine-comments" itemprop="discussionUrl">
      <span class="post-comments-count valine-comment-count" data-xid="/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/" itemprop="commentCount"></span>
    </a>
  </span>
  ...
  <br>
    ...
    <div class="post-body" itemprop="articleBody">
        ...
        <h1 id="Config-Array"><a href="#Config-Array" class="headerlink" title="Config Array"></a>Config Array</h1><p>by <a target="_blank" rel="noopener" href="https://humanwhocodes.com/">Nicholas C. Zakas</a></p>
...
<h2 id="Background"><a href="#Background" class="headerlink" title="Background"></a>Background</h2><p>In 2019, I submitted an <a target="_blank" rel="noopener" href="https://github.com/eslint/rfcs/pull/9">ESLint RFC</a> proposing a new way of configuring ESLint. The goal was to streamline what had become an increasingly complicated configuration process. Over several iterations, this proposal was eventually born.</p>
...
<figure class="highlight bash"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br></pre></td><td class="code"><pre><span class="line">npm install @humanwhocodes/config-array --save</span><br><span class="line"></span><br><span class="line"><span class="comment"># or</span></span><br><span class="line"></span><br><span class="line">yarn add @humanwhocodes/config-array</span><br></pre></td></tr></table></figure>

<h2 id="Usage"><a href="#Usage" class="headerlink" title="Usage"></a>Usage</h2><p>First, import the <code>ConfigArray</code> constructor:</p>
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">import</span> &#123; <span class="title class_">ConfigArray</span> &#125; <span class="keyword">from</span> <span class="string">&quot;@humanwhocodes/config-array&quot;</span>;</span><br><span class="line"></span><br><span class="line"><span class="comment">// or using CommonJS</span></span><br><span class="line"></span><br><span class="line"><span class="keyword">const</span> &#123; <span class="title class_">ConfigArray</span> &#125; = <span class="built_in">require</span>(<span class="string">&quot;@humanwhocodes/config-array&quot;</span>);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br><span class="line">10</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">const</span> configFilename = path.<span class="title function_">resolve</span>(process.<span class="title function_">cwd</span>(), <span class="string">&quot;my.config.js&quot;</span>);</span><br><span class="line"><span class="keyword">const</span> &#123; <span class="attr">default</span>: rawConfigs &#125; = <span class="keyword">await</span> <span class="keyword">import</span>(configFilename);</span><br><span class="line"><span class="keyword">const</span> configs = <span class="keyword">new</span> <span class="title class_">ConfigArray</span>(rawConfigs, &#123;</span><br><span class="line">    </span><br><span class="line">    <span class="comment">// the path to match filenames from</span></span><br><span class="line">    <span class="attr">basePath</span>: process.<span class="title function_">cwd</span>(),</span><br><span class="line"></span><br><span class="line">    <span class="comment">// additional items in each config</span></span><br><span class="line">    <span class="attr">schema</span>: mySchema</span><br><span class="line">&#125;);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br><span class="line">10</span><br><span class="line">11</span><br><span class="line">12</span><br><span class="line">13</span><br><span class="line">14</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">export</span> <span class="keyword">default</span> [</span><br><span class="line">    </span><br><span class="line">    <span class="comment">// Always ignored</span></span><br><span class="line">    &#123;</span><br><span class="line">        <span class="attr">ignores</span>: [<span class="string">&quot;**/.git/**&quot;</span>, <span class="string">&quot;**/node_modules/**&quot;</span>]</span><br><span class="line">    &#125;,</span><br><span class="line"></span><br><span class="line">    <span class="comment">// .eslintrc.js file is ignored only when .js file matches</span></span><br><span class="line">    &#123;</span><br><span class="line">        <span class="attr">files</span>: [<span class="string">&quot;**/*.js&quot;</span>],</span><br><span class="line">        <span class="attr">ignores</span>: [<span class="string">&quot;.eslintrc.js&quot;</span>]</span><br><span class="line">        <span class="attr">handler</span>: jsHandler</span><br><span class="line">    &#125;</span><br><span class="line">];</span><br></pre></td></tr></table></figure>

<p>You can use negated patterns in <code>ignores</code> to exclude a file that was already ignored, such as:</p>
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">export</span> <span class="keyword">default</span> [</span><br><span class="line">    </span><br><span class="line">    <span class="comment">// Ignore all JSON files except tsconfig.json</span></span><br><span class="line">    &#123;</span><br><span class="line">        <span class="attr">files</span>: [<span class="string">&quot;**/*&quot;</span>],</span><br><span class="line">        <span class="attr">ignores</span>: [<span class="string">&quot;**/*.json&quot;</span>, <span class="string">&quot;!tsconfig.json&quot;</span>]</span><br><span class="line">    &#125;,</span><br><span class="line"></span><br><span class="line">];</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">await</span> configs.<span class="title function_">normalize</span>(&#123;</span><br><span class="line">    <span class="attr">name</span>: <span class="string">&quot;MyApp&quot;</span></span><br><span class="line">&#125;);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">await</span> configs.<span class="title function_">normalizeSync</span>(&#123;</span><br><span class="line">    <span class="attr">name</span>: <span class="string">&quot;MyApp&quot;</span></span><br><span class="line">&#125;);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br></pre></td><td class="code"><pre><span class="line"><span class="comment">// pass in absolute filename</span></span><br><span class="line"><span class="keyword">const</span> fileConfig = configs.<span class="title function_">getConfig</span>(path.<span class="title function_">resolve</span>(process.<span class="title function_">cwd</span>(), <span class="string">&quot;package.json&quot;</span>));</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">const</span> ignored = configs.<span class="title function_">isFileIgnored</span>(<span class="string">&#x27;/foo/bar/baz.txt&#x27;</span>);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">const</span> ignored = configs.<span class="title function_">isDirectoryIgnored</span>(<span class="string">&#x27;/foo/bar/&#x27;</span>);</span><br></pre></td></tr></table></figure>
...
<ul class="post-copyright">
  ...
  <li class="post-copyright-link">
    <strong>本文链接：</strong>
    <a href="http://jackie-li-0228.github.io/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/" title="">http://jackie-li-0228.github.io/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/config-array/README/</a>
  </li>
  <li class="post-copyright-license">
    ...
    <a href="/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint-community/regexpp/README/" rel="prev" title="">
      <i class="fa fa-chevron-left"></i> 
    </a></div>
      <div class="post-nav-item">
    <a href="/2024/10/29/obsidian-smart-completion-plugin-for-hexo/node_modules/@humanwhocodes/module-importer/CHANGELOG/" rel="next" title="">
  ...
  <aside class="sidebar">
    <div class="sidebar-inner">
      ...
      <div class="post-toc-wrap sidebar-panel">
          <div class="post-toc motion-element"><ol class="nav"><li class="nav-item nav-level-1"><a class="nav-link" href="#Config-Array"><span class="nav-number">1.</span> <span class="nav-text">Config Array</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#Description"><span class="nav-number">1.1.</span> <span class="nav-text">Description</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Background"><span class="nav-number">1.2.</span> <span class="nav-text">Background</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Installation"><span class="nav-number">1.3.</span> <span class="nav-text">Installation</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Usage"><span class="nav-number">1.4.</span> <span class="nav-text">Usage</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#Specifying-a-Schema"><span class="nav-number">1.4.1.</span> <span class="nav-text">Specifying a Schema</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#Config-Arrays"><span class="nav-number">1.4.2.</span> <span class="nav-text">Config Arrays</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#Config-Functions"><span class="nav-number">1.4.3.</span> <span class="nav-text">Config Functions</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#Normalizing-Config-Arrays"><span class="nav-number">1.4.4.</span> <span class="nav-text">Normalizing Config Arrays</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#Getting-Config-for-a-File"><span class="nav-number">1.4.5.</span> <span class="nav-text">Getting Config for a File</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Determining-Ignored-Paths"><span class="nav-number">1.5.</span> <span class="nav-text">Determining Ignored Paths</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Caching-Mechanisms"><span class="nav-number">1.6.</span> <span class="nav-text">Caching Mechanisms</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Acknowledgements"><span class="nav-number">1.7.</span> <span class="nav-text">Acknowledgements</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#License"><span class="nav-number">1.8.</span> <span class="nav-text">License</span></a></li></ol></li></ol></div>
      </div>
      <!--/noindex-->
