...
<script>
  ...
  <meta name="description" content="ESLintRC LibraryThis repository contains the legacy ESLintRC configuration file format for ESLint. This package is not intended for use outside of the ESLint ecosystem. It is ESLint-specific and not i">
<meta property="og:type" content="article">
<meta property="og:title" content="JackieLi的小屋">
<meta property="og:url" content="http://jackie-li-0228.github.io/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/index.html">
<meta property="og:site_name" content="JackieLi的小屋">
<meta property="og:description" content="ESLintRC LibraryThis repository contains the legacy ESLintRC configuration file format for ESLint. This package is not intended for use outside of the ESLint ecosystem. It is ESLint-specific and not i">
<meta property="og:locale" content="zh_CN">
<meta property="article:published_time" content="2025-04-06T08:20:48.477Z">
<meta property="article:modified_time" content="2024-09-03T03:23:43.037Z">
<meta property="article:author" content="JackieLi">
<meta property="article:tag" content="Programming Math Others">
<meta name="twitter:card" content="summary">

<link rel="canonical" href="http://jackie-li-0228.github.io/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/">
...
<div id="search-result">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-block" lang="zh-CN">
    <link itemprop="mainEntityOfPage" href="http://jackie-li-0228.github.io/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/">
    ...
    <span hidden itemprop="publisher" itemscope itemtype="http://schema.org/Organization">
      ...
      <header class="post-header">
        ...
        <div class="post-meta">
            ...
            <span id="/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/" class="post-meta-item leancloud_visitors" data-flag-title="" title="阅读次数">
              <span class="post-meta-item-icon">
                <i class="fa fa-eye"></i>
              </span>
  ...
  <span class="post-meta-item">
    ...
    <a title="valine" href="/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/#valine-comments" itemprop="discussionUrl">
      <span class="post-comments-count valine-comment-count" data-xid="/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/" itemprop="commentCount"></span>
    </a>
  </span>
  ...
  <br>
    ...
    <div class="post-body" itemprop="articleBody">
        ...
        <h1 id="ESLintRC-Library"><a href="#ESLintRC-Library" class="headerlink" title="ESLintRC Library"></a>ESLintRC Library</h1><p>This repository contains the legacy ESLintRC configuration file format for ESLint. This package is not intended for use outside of the ESLint ecosystem. It is ESLint-specific and not intended for use in other programs.</p>
...
<figure class="highlight plaintext"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br></pre></td><td class="code"><pre><span class="line">npm install @eslint/eslintrc --save-dev</span><br><span class="line"></span><br><span class="line"># or</span><br><span class="line"></span><br><span class="line">yarn add @eslint/eslintrc -D</span><br></pre></td></tr></table></figure>
...
<ul class="post-copyright">
  ...
  <li class="post-copyright-link">
    <strong>本文链接：</strong>
    <a href="http://jackie-li-0228.github.io/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/" title="">http://jackie-li-0228.github.io/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/eslintrc/README/</a>
  </li>
  <li class="post-copyright-license">
    ...
    <a href="/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@esbuild/win32-x64/README/" rel="prev" title="">
      <i class="fa fa-chevron-left"></i> 
    </a></div>
      <div class="post-nav-item">
    <a href="/2025/04/06/obsidian-smart-completion-plugin-for-hexo/node_modules/@eslint/js/README/" rel="next" title="">
  ...
  <aside class="sidebar">
    <div class="sidebar-inner">
      ...
      <div class="post-toc-wrap sidebar-panel">
          <div class="post-toc motion-element"><ol class="nav"><li class="nav-item nav-level-1"><a class="nav-link" href="#ESLintRC-Library"><span class="nav-number">1.</span> <span class="nav-text">ESLintRC Library</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#Installation"><span class="nav-number">1.1.</span> <span class="nav-text">Installation</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Usage-ESM"><span class="nav-number">1.2.</span> <span class="nav-text">Usage (ESM)</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Usage-CommonJS"><span class="nav-number">1.3.</span> <span class="nav-text">Usage (CommonJS)</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#License"><span class="nav-number">1.4.</span> <span class="nav-text">License</span></a></li></ol></li></ol></div>
      </div>
      <!--/noindex-->
